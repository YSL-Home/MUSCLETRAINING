...
export const metadata: Metadata = {
  title: "Conditions Générales d'Utilisation — Sport It",
  description: "Consultez les conditions générales d'utilisation du site Sport It. Informations légales, responsabilités, données personnelles et propriété intellectuelle.",
...
const SECTIONS = [
  {
    ...
    contenu: `Sport It (accessible à l'adresse www.sportit.fr) est un site web à vocation informative et éducative dans le domaine de la musculation, du sport et de la santé physique.
...
L'accès au site est entièrement gratuit et ne nécessite aucune inscription.`,
  },
  {
    ...
    contenu: `IMPORTANT : Les informations publiées sur Sport It ont un caractère purement informatif et ne constituent en aucun cas un avis médical, un diagnostic ou une prescription.
...
Sport It décline toute responsabilité en cas de blessure, d'accident ou de problème de santé résultant de la pratique des exercices présentés sur le site, que ces exercices aient été suivis correctement ou non.`,
  },
  {
    id: 'propriete',
    titre: '3. Propriété intellectuelle',
    contenu: `L'ensemble des contenus présents sur Sport It (textes, illustrations SVG, structure des programmes, descriptions d'exercices) sont la propriété exclusive de Sport It, sauf mention contraire.

Contenus tiers :
— Les vidéos intégrées proviennent de YouTube et appartiennent à leurs créateurs respectifs. Sport It n'en revendique aucune propriété.
...
Vous êtes autorisé à partager des liens vers nos pages et à utiliser les contenus à des fins personnelles et non commerciales, en citant la source.`,
  },
  {
    ...
    contenu: `Sport It s'efforce de maintenir des informations exactes et à jour. Toutefois, le site ne peut garantir l'exactitude, l'exhaustivité ou l'actualité de toutes les informations publiées.

Sport It ne saurait être tenu responsable :
...
Les vidéos YouTube intégrées sont soumises aux conditions d'utilisation de YouTube/Google. Sport It ne contrôle pas leur disponibilité ni leur contenu.`,
  },
  {
    id: 'donnees',
    titre: '5. Données personnelles (RGPD)',
    contenu: `Sport It s'engage à respecter votre vie privée conformément au Règlement Général sur la Protection des Données (RGPD — UE 2016/679).
...
Vous pouvez configurer votre navigateur pour refuser les cookies, ce qui peut affecter certaines fonctionnalités du site.`,
  },
  {
    ...
    contenu: `Sport It peut contenir des liens vers des sites tiers (YouTube, réseaux sociaux, etc.). Ces liens sont fournis à titre informatif uniquement.

Sport It n'exerce aucun contrôle sur le contenu de ces sites et décline toute responsabilité quant à leur disponibilité, leur exactitude ou leurs pratiques en matière de confidentialité.

La création de liens vers Sport It est libre, à condition que :
— Le lien ne soit pas trompeur ou malveillant
— Le site source ne porte pas atteinte à l'image de Sport It
— Le contenu ne soit pas reproduit dans un cadre (iframe) sans autorisation`,
  },
  {
    id: 'modification',
    titre: '8. Modification des CGU',
    contenu: `Sport It se réserve le droit de modifier les présentes Conditions Générales d'Utilisation à tout moment et sans préavis.
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-6 mb-10">
        ...
        <div className="mt-4 p-4 bg-lime-50 border border-lime-200 rounded-xl text-sm text-lime-800">
          <strong>En utilisant Sport It, vous acceptez les présentes conditions.</strong> Veuillez les lire attentivement, en particulier l&apos;avertissement médical (section 2).
        </div>
      </div>
      ...
      <div className="mt-14 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <p className="text-xs text-slate-400">
          © {new Date().getFullYear()} Sport It — Tous droits réservés<br />
