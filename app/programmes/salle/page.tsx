  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-10">
        ...
        <h1 className="text-4xl font-black text-slate-900 mb-3">Programmes Salle</h1>
        <p className="text-slate-600 text-lg max-w-2xl">Programmes conçus pour la salle de sport avec barre, haltères et machines. Progressions claires et exercices avec vidéos.</p>
      </div>
