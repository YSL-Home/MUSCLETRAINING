  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-10">
        ...
        <h1 className="text-4xl font-black text-slate-900 mb-3">Programmes Maison</h1>
        <p className="text-slate-600 text-lg max-w-2xl">Programmes sans matériel ou avec minimal (barre de traction). Efficaces, progressifs et avec vidéos pour chaque exercice.</p>
      </div>
