  ...
  return (
    <html lang="fr">
      <head>
        ...
        />
        {/* Google tag (gtag.js) — GA4 G-WMP7K44RCN */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-WMP7K44RCN" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-WMP7K44RCN');` }} />
        {/* Google Tag Manager */}
