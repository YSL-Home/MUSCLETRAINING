  ...
  return (
    <html lang="fr">
      <head>
        ...
        />
        {/* Google tag (gtag.js) — GA4 G-0DCMSB88CW */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-0DCMSB88CW" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-0DCMSB88CW');` }} />
        {/* Google Tag Manager */}
