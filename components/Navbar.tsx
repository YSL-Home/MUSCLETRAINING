...
export default function Navbar() {
  ...
  return (
    <nav style={{ background: '#0a0a0a', borderBottom: '1px solid #1f1f1f' }} className="sticky top-0 z-50 shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/programmes" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">
              Programmes
            </Link>
            <Link href="/sport" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">
              Sports
            </Link>
            <Link href="/machines" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">
              Machines
            </Link>
            <Link href="/calculateurs" className="text-slate-400 hover:text-white text-sm font-medium transition-colors">
              Calculateurs
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              style={{
                background: mode === 'salle' ? '#1a2200' : '#14532d',
                color: mode === 'salle' ? '#b8d400' : '#4ade80',
                border: `1px solid ${mode === 'salle' ? '#b8d400' : '#22c55e'}`,
              }}
            >
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="md:hidden pb-4 border-t border-zinc-800 mt-2 pt-4 flex flex-col gap-3">
